...
/**
 * Exception thrown when there are issues parsing the response from the update server.
 * This includes JSON parsing errors, missing required fields, or unexpected data formats.
 *
 * @author Lucas Greuloch (greluc, lucas.greuloch@protonmail.com)
 * @version 1.6.0
 * @since 1.6.0
 */
public class ParseException extends UpdateException {
