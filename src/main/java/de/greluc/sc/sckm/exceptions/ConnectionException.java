...
/**
 * Exception thrown when there are network connection issues during update operations.
 * This includes problems connecting to the update server, SSL/TLS issues, or API errors.
 *
 * @author Lucas Greuloch (greluc, lucas.greuloch@protonmail.com)
 * @version 1.6.0
 * @since 1.6.0
 */
public class ConnectionException extends UpdateException {
